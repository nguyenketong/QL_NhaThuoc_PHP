...
<body>
    <div class="login-card">
        <div class="login-header">
            ...
            <h4>Admin Panel</h4>
            <p class="mb-0 mt-2 opacity-75">Đăng nhập quản trị viên</p>
        </div>
        <div class="login-body">
            ...
            <form method="post">
                <div class="mb-3">
                    ...
                    <input type="text" name="soDienThoai" class="form-control" required placeholder="Nhập SĐT admin" />
                </div>
                <div class="mb-4">
            ...
            <div class="text-center mt-4">
                <a href="<?= BASE_URL ?>/" class="text-muted"><i class="fas fa-arrow-left"></i> Về trang chủ</a>
            </div>
        </div>
    </div>
</body>
